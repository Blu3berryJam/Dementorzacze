...
def get_products(cat_name,subcategory):
    ...
    for product in product_divs:
        ...
        products.append({"name":name,"brand":brand,"description":desc,"power": power,"dimensions":dimensions,"price":price,"category":cat_name,"subcategory":subcategory[0]}) #add product info to products list
    return products
